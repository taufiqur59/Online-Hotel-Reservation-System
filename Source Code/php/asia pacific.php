  ...
  <li>
   ...
   <ul class="eachfacul">
    ...
    <div  class="contentheaddiv">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">USD 170</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">USD 140</h3>
     </div>
     </div>
     <div class="eachbookitem1">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">USD 180</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">USD 145</h3>
     </div>
     </div>
     <div class="eachbookitem2">
       <h3 class="booklineia">Available</h3>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">USD 165</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">USD 130</h3>
     </div>
     </div>
     <div class="eachbookitem1">
       <h3 class="booklineia">Available</h3>
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">USD 140</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">USD 110</h3>
     </div>
     </div>
     <div class="eachbookitem2">
       <h3 class="booklineia">Available</h3>
    ...
    <div class="mainbookitem">
     ...
     <div class="eachbookitem1">
     <div class="fprice">
       <h3 class="h3pricef">USD 145</h3></div>
     <div class="lprice">
       <h3 class="h3pricel">USD 115</h3>
     </div>
     </div>
     <div class="eachbookitem1">
       <h3 class="booklineia">Available</h3>
